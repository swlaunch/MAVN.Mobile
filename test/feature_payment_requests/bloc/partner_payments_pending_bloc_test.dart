...
BlocTester<PartnerPaymentsBloc> _blocTester =
    BlocTester(PendingPartnerPaymentsBloc(_mockPartnerRepository));
...
void main() {
  group('PaginatedPartnerPaymentsBlocTests', () {
    setUp(() {
      ...
      _subject = PendingPartnerPaymentsBloc(_mockPartnerRepository);
    ...
    test('get payments success', () async {
      when(
        _mockPartnerRepository.getPendingPayments(
      ...
      verify(_mockPartnerRepository.getPendingPayments(
    ...
    test('get payments generic error', () async {
      when(_mockPartnerRepository.getPendingPayments(
        currentPage: anyNamed('currentPage'),
      )).thenThrow(Exception());
