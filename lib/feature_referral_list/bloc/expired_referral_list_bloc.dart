...
class ExpiredReferralListBloc extends ReferralListBloc {
  ExpiredReferralListBloc(this._referralRepository);

  final ReferralRepository _referralRepository;

  @override
  Future<ReferralsListResponseModel> loadData(int page) =>
      _referralRepository.getExpiredReferrals(currentPage: page);
}

ExpiredReferralListBloc useExpiredReferralListBloc() =>
    ModuleProvider.of<ReferralListModule>(useContext()).expiredReferralListBloc;
