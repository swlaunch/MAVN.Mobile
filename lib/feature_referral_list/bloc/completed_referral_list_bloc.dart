...
class CompletedReferralListBloc extends ReferralListBloc {
  CompletedReferralListBloc(this._referralRepository);

  final ReferralRepository _referralRepository;

  @override
  Future<ReferralsListResponseModel> loadData(int page) =>
      _referralRepository.getApprovedReferrals(currentPage: page);
}

CompletedReferralListBloc useCompletedReferralListBloc() =>
    ModuleProvider.of<ReferralListModule>(useContext())
        .completedReferralListBloc;
