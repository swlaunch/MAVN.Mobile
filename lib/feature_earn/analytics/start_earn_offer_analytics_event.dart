...
class StartEarnOfferAnalyticsEvent extends AnalyticsEvent {
  StartEarnOfferAnalyticsEvent({
    @required this.conditionType,
    @required this.offerId,
  }) : super(
          success: true,
          eventName: AnalyticsEventName.startEarnOffer,
  ...
  Map<String, dynamic> get eventParametersMap => super.eventParametersMap
    ..addAll({
      if (conditionType != null) 'action': conditionType.toString(),
      'offer_id': offerId,
    });
}
