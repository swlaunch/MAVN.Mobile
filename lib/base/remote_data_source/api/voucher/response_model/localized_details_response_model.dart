...
class LocalizedVoucherDetails {
  LocalizedVoucherDetails.fromJson(Map<String, dynamic> json)
      : id = json['Id'],
  ...
  static List<LocalizedVoucherDetails> toListFromJson(List list) =>
      list.map((json) => LocalizedVoucherDetails.fromJson(json)).toList();
